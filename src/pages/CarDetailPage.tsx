...
import {
  ...
  Building2, X, ZoomIn, Loader2, Star, ExternalLink, Phone
} from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-10 lg:gap-12 items-start">
            ...
            <div className="space-y-8 min-w-0">
              ...
              <Tabs defaultValue="description">
                <TabsList className="border-b border-border bg-transparent rounded-none w-full justify-start h-auto pb-0 gap-0">
                  {['description', 'specs', 'seller'].map(tab => (
            ...
            <div className="space-y-4 lg:sticky lg:top-20">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-secondary/50 border border-border/50">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-[11px] text-muted-foreground">{contactType === 'admin' ? 'Admin contact' : 'Dealer contact'}</p>
                    <p className="text-xs font-medium truncate">{displayPhone}</p>
                  </div>
                ...
                <a href={whatsappUrl} target="_blank" rel="noopener noreferrer"
                  className="whatsapp-btn justify-center h-10 text-sm font-medium">
                  <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <path d="M12 0C5.373 0 0 5.373 0 12c0 2.124.554 4.12 1.523 5.858L0 24l6.335-1.652A11.93 11.93 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.818a9.818 9.818 0 01-5.006-1.374l-.359-.214-3.72.97.991-3.624-.235-.373A9.78 9.78 0 012.182 12c0-5.418 4.4-9.818 9.818-9.818 5.418 0 9.818 4.4 9.818 9.818 0 5.418-4.4 9.818-9.818 9.818z"/>
                  </svg>
                  Chat on WhatsApp
                </a>
